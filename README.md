...
​
### Updating
MangaVerse **checks for updates on launch**. When a newer version is available, you'll see a prompt with a one-tap link to download the latest APK from the Releases page. You can also check Releases manually anytime.
​
---
​
## 🔐 Permissions
​
MangaVerse only asks for what it needs:
​
| Permission | Why it's used |
|---|---|
| **Internet** | Load series, covers, and chapters. |
| **Storage** (Android 12 and below) | Save downloaded chapters for offline reading. |
| **Notifications** | Alert you about new chapters. |
​
---
​
## 🛡️ Privacy
​
- Your **library, reading history, downloads, and settings are stored on your device**.
- If you choose to create an account, your library and progress are securely synced so you can continue on another device.
- No ads. No trackers selling your data.
​
---
​
## ❓ FAQ
...
## ⚖️ Disclaimer
​
MangaVerse is a **reader client** for personal, non-commercial use. It does not host any manga content; all content is provided by third-party sources. All rights to the content belong to their respective creators and publishers. Please support official releases where available.
​
---
​
<div align="center">
